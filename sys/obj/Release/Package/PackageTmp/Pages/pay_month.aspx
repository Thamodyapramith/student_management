<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pay_month.aspx.cs" Inherits="sys.Pages.pay_month" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container mt-5">
            <h1 class="mb-4">Pay Monthly Fee</h1>
...
<%--                <asp:TextBox ID="txtId" runat="server" CssClass="form-control" TextMode ="Number" OnTextChanged ="txtId_TextChanged"></asp:TextBox>--%>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtAnnualFee" runat="server" CssClass="form-control" ReadOnly ="true" TextMode ="Number"></asp:TextBox>
            </div>
            <div class="form-group">
                <label for="txtAnnualFeeDate">Annual Fee Date:</label>
                <asp:TextBox ID="txtAnnualFeeDate" runat="server" CssClass="form-control" ReadOnly ="true" TextMode ="date"></asp:TextBox>
            </div>
            <div class="form-group">
